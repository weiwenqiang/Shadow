...
public class RegexUtil {
     ...
     * 满足六位Pattern
     */
    public static final Pattern SIX_NUMBER_PATTERN = Pattern
            .compile("\\S{6,}");
    /**
     * 满足八位Pattern
     */
    public static final Pattern EIGHT_NUMBER_PATTERN = Pattern
            .compile("\\S{8,}");
    /**
     * 满足六位Pattern
     */
    public static final Pattern TEXT_DEFAULT = Pattern
            .compile("\\S+");

    /**
     * 0-10折扣数 一位小数
     */
    public static final Pattern ONE_DISCOUNT_PATTERN = Pattern
            .compile("^\\(\\d(\\.\\d)?|10\\)$");
     ...
     * @return
     */
    public static boolean isSixNumber(String s) {
        Matcher m = SIX_NUMBER_PATTERN.matcher(s);
        return m.matches();
    }
     ...
     * @return
     */
    public static boolean isEightNumber(String s) {
        Matcher m = EIGHT_NUMBER_PATTERN.matcher(s);
        return m.matches();
    }
    ...
    public static boolean isDefault(String s) {
        Matcher m = TEXT_DEFAULT.matcher(s);
        return m.matches();
    }
     ...
     * @return
     */
    public static boolean isDiscount(String s) {
        Matcher m = ONE_DISCOUNT_PATTERN.matcher(s);
        return m.matches();
    }
     ...
     * 验证手机号码
     */
    public static final boolean isMobileNOOld(String mobiles) {
        Pattern p = Pattern
     ...
     * 提取字符串开头数字
     */
    public static String extractNumberPrefix(String s) {
...
//            T.success("0: " + m.group(0) + " 1: " + m.group(1) + " 2: " + m.group(2) + " 3: " + m.group(3));
        } else {
