...
/**
 * Created by wenxiang on 16-11-28.
 */
...
public class ClearEditText extends AppCompatEditText {
     ...
     * 默认的清除按钮图标资源
     */
    private static final int ICON_CLEAR_DEFAULT = R.mipmap.ic_search_delete;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (xDown >= (getWidth() - getCompoundPaddingRight() - 5) && xDown < getWidth()) {
                // 清空文本
                setText("");
            }
        }
