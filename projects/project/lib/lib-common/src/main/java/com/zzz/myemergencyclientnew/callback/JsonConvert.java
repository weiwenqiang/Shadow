...
public class JsonConvert<T> implements Converter<T> {
    ...
    public static final String  errorSign = "ShowMsg:";
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != RespJson.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                RespJson lzyResponse = Convert.fromJson(jsonReader, type);
                response.close();
                ...
                if (code == 200) {
                    ...
                    throw new IllegalStateException(errorSign+lzyResponse.msg);
                } else if (code == 105) {
