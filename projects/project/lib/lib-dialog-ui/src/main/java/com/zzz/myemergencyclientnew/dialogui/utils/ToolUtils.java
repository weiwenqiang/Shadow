package com.zzz.myemergencyclientnew.dialogui.utils;
...
public class ToolUtils {
    ...
    public static void showDialogHandler(final Dialog dialog, final BuildBean bean) {
        DialogUIUtils.getMainHandler().post(new Runnable() {
            @Override
            public void run() {
                try {
                    dialog.show();
