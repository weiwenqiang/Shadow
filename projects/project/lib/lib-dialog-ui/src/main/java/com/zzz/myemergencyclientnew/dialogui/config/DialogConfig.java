package com.zzz.myemergencyclientnew.dialogui.config;
...
public class DialogConfig {
    ...
    //修改属性？？？
    public static final int TYPE_IOS_ATTRIBUTE_SINGLE = 103;
    public static final int TYPE_MD_MULTI_CHOOSE_ADD = 104;
    public static final int TYPE_MD_MULTI_CHOOSE_WORKDAY = 105;
    //时间段选择器
    public static final int TYPE_DATEPICK_STAGE = 106;
    //单修改框
    public static final int TYPE_ALERT_SOLO = 107;
}
