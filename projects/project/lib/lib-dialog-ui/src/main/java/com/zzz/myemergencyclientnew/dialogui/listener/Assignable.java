...
public interface Assignable {
     ...
     * 自定义时间段选择器
     */
    BuildBean assignDatePickStage(Context context, int gravity, String dateTitle, long date, int dateType, int tag, DialogUIDateTimeSaveListener listener);
     ...
     * 独立修改框
     */
    BuildBean assignSoloAlert(Context activity, CharSequence title, CharSequence msg, CharSequence hint1,
                          CharSequence firstTxt, CharSequence secondTxt, boolean cancleable, boolean outsideTouchable, final DialogUISoloListener listener);
     ...
     * 魏文强 添加商品属性对话框
     */
    BuildBean addCommodityAttribute(Context context, CharSequence title, CharSequence hint1, int addNumber, CharSequence strArray,
                                     CharSequence btn1, CharSequence btn2, CharSequence btn3,  final DialogUIAddListener listener);

    /**
     * 魏文强 添加商品规格对话框
     */
    BuildBean addCommodityStandard(Context context, CharSequence title, CharSequence hint1, CharSequence hint2, int addNumber, Map<String, String> map,
                                    CharSequence btn1, CharSequence btn2, CharSequence btn3,  final DialogUIAddListener listener);
    /**
     * 魏文强 添加商品属性对话框
     */
    BuildBean addCommodityAttributeSingle(Context context, CharSequence title, CharSequence hint1,CharSequence btn3, CharSequence btn4, final DialogUIAddListener listener);
    /**
     * 魏文强 带添加按钮的多选框
     */
    BuildBean assignMdMultiChooseAdd(Activity context, CharSequence title, CharSequence btn3, final CharSequence[] words, final boolean[] checkedItems, boolean cancleable, boolean outsideTouchable,
                                  final DialogUIListener btnListener);
    /**
     * 魏文强 选择工作日多选框
     */
    BuildBean assignMdMultiChooseWorkday(Activity context, CharSequence title, final CharSequence[] words, final boolean[] checkedItems, boolean cancleable, boolean outsideTouchable,
                                  final DialogUIListener btnListener);
