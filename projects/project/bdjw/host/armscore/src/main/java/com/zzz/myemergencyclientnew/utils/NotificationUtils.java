...
//     * 全局弹出通知栏方法,携带参数跳转页面
//     */
//    public static void showNotification(String title, String context, Intent intent) {
...
//        Notification.Builder builder = new Notification.Builder(HostApplication.getApp());
//        builder.setContentTitle(title)
//                .setContentText(context)
//                .setWhen(System.currentTimeMillis())
//                .setSmallIcon(R.mipmap.ic_launcher)
//                .setLargeIcon(BitmapFactory.decodeResource(HostApplication.getApp().getResources(), R.mipmap.ic_launcher));
...
//        NotificationManager manager = (NotificationManager) HostApplication.getApp().getSystemService(Context.NOTIFICATION_SERVICE);
...
//     * 全局弹出通知栏方法,纯显示
//     */
//    public static void showNotification(String title, String context) {
//        //通知栏点击时需要一个唯一ID，确认地址跳转，这里我用了时间戳截取方式，一定程度上保证唯一
//        String timeString = "" + System.currentTimeMillis();
//        int timeId = Integer.valueOf(timeString.substring(timeString.length() - 4, timeString.length()));
//        Notification.Builder builder = new Notification.Builder(HostApplication.getApp());
