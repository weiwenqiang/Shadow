...
import com.zzz.myemergencyclientnew.databinding.FragmentLoginForgetPasswordBinding;
...
public class ForgetPasswordFragment extends BaseFragment<ForgetPasswordPresenter, FragmentLoginForgetPasswordBinding> implements ForgetPasswordContract.View {
    ...
    public void initView() {
        ...
        loginActivity.setToolbarTitle("忘记密码");
        ...
        mViewBinding.edtLoginCode.setRegexCorrectListener(new RegexCorrectListener() {
            ...
            public void isRegexCorrect(View view, boolean isRegexCorrect) {
                ...
                mViewBinding.btnConfirm.setEnabled(phoneCorrect);
            }
        });
    ...
    public void netVerifyRegister(String resp) {
        mPresenter.netAppForgetPassword(mActivity, phoneStr, passwordStr);
    }

    @Override
    public void netAppForgetPassword(String resp) {
